...
const Appointment = () => {
  ...
  const ldHowTo = {
    ...
    "step": [
      ...
      { "@type": "HowToStep", "name": "Pick your preferred date" },
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        ...
        <meta
          name="description"
          content="Professional moving service appointments in Halifax & all over HRM. Free quotes and transparent pricing."
        />
        ...
        <meta
          ...
          content="Professional moving service appointments in HRM. Free quotes and transparent pricing."
        />
        ...
        <meta
          ...
          content="Schedule your moving service—fast, insured, and stress-free."
        />
          ...
          <CardContent className="p-1">
            ...
            <section aria-label="How booking works" className="mt-8">
              ...
              <ol className="mt-3 space-y-2 list-decimal list-inside text-gray-700">
                <li>Choose the service type and tell us what you are moving.</li>
                <li>Select your preferred target moving date.</li>
                <li>Submit the form—our team will confirm details and provide a firm estimate.</li>
              </ol>
            </section>
          </CardContent>
        </Card>

        {/* Updated secondary links block for moving services */}
        <nav aria-label="Secondary" className="mt-8 text-sm text-gray-700">
          <ul className="flex flex-wrap gap-4">
            <li>
              <Link to="/services/residential-moving" className="hover:underline">
                Residential Moving
              </Link>
            </li>
            <li>
              <Link to="/services/commercial-moves" className="hover:underline">
                Commercial Moves
              </Link>
            </li>
            <li>
              <Link to="/services/packing-and-unpacking" className="hover:underline">
                Packing & Unpacking
              </Link>
            </li>
            <li>
