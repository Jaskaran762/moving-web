...
export const APPOINTMENT_FUNCTION_URL = "https://us-central1-places-api-project-467513.cloudfunctions.net/appointment-save-junk"; // TODO: set to your GCP function URL
